...
По умолчанию сканирует `/int/core/brain/web/static/diagnostics`, исключая .git, venv, node_modules и build-артефакты.
...
def main() -> int:
    ...
    parser.add_argument(
        'root', nargs='?', default='/int/core/brain/web/static/diagnostics',
        help='Каталог для проверки (по умолчанию /int/core/brain/web/static/diagnostics)'
    )
    parser.add_argument(
